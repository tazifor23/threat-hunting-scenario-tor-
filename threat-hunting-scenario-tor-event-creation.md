...
## Created By:
- **Author Name**: Morfaw Tazifor
- **Author Contact**: https://www.linkedin.com/in/m-taz/
- **Date**: Feb 20th, 2025
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `September  6, 2024`  | `Morfaw TTazifor`   # Threat Event (Unauthorized TOR Usage)
**Unauthorized TOR Browser Installation and Use**
...
| **Version** | **Changes**                   | **Date**         | **Modified By**   |
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `September  6, 2024`  | `Morfaw tazifor`   
